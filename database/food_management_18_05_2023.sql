...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 18 mai 2023 à 13:28
...
(3, 'Toaste', NULL),
(4, 'Tacos', NULL),
(6, 'Pop Quesadilas', NULL),
(7, 'Tex Mex', NULL),
(8, 'Baby Boss', NULL),
(9, 'Brunche (08h - 11h)', NULL),
(10, 'Boisson', NULL);
...
(1, '1', NULL, NULL, NULL, NULL, 0, '1000.00', NULL, NULL),
...
(1, NULL, 'Big Pop', '3 Pain - 2 Steak - Black angus - Sauce giant - Salade - Cornichon - 2 Cheddar', '600.00', NULL, 1),
(2, NULL, 'Cheesburger ', '1 Steak - Black angus - cornichon - Sauce Ketchup - moutarde- 1 Cheddar', '400.00', NULL, 1),
(3, NULL, 'Double Chezze', '2 Steak 100 g - Black augus - Ketchups - Moutarde - oignons - Cornichon - 2 cheddar', '500.00', NULL, 1),
(4, NULL, 'Triple cheeze', '3 Steak 100 g - Black augus - Ketchups - Moutarde - oignons - Cornichon - 3 cheddar', '600.00', NULL, 1),
(5, NULL, 'Pop chiken', '100 g de poulet - mayo - poivre - oignons - cornichon', '550.00', NULL, 1),
(6, NULL, 'Pop fish ', 'Filet de colin pané - sauce fish - cheddar', '700.00', NULL, 1),
(7, NULL, 'Pop Quesadillas Bavette', '', '1000.00', NULL, 2),
(8, NULL, 'Pop Quesadillas Veau', '', '1200.00', NULL, 2),
(9, NULL, 'Pop Quesadillas Viande haché', '', '1000.00', NULL, 2),
(10, NULL, 'Pop Quesadillas tandoor', '', '1200.00', NULL, 2),
(11, NULL, 'Pop Quesadillas Curry', '', '1500.00', NULL, 2),
(12, NULL, 'Pop Quesadillas Viande Escalo', '', '1000.00', NULL, 2),
(13, NULL, 'Tex Mex Mozza stick', '', '500.00', NULL, 2),
(14, NULL, 'Tex Mex	Boucher de camembert', '', '500.00', NULL, 2),
(15, NULL, 'Tex Mex Tenders', '', '500.00', NULL, 2),
(16, NULL, 'Tex Mex Japalenos', '', '1500.00', NULL, 2),
(17, NULL, 'Tex Mex Nuggets', '', '1200.00', NULL, 2),
(18, NULL, 'Tex Mex Wings', '', '800.00', NULL, 2),
(19, NULL, 'Baby Boss', '6 nuggets ou Cheeze au choix Jus + cadeau', '1200.00', NULL, 2),
(20, NULL, 'Branche (08h - 11h)', 'POP brunch : Bruschetta avocat saumon œuf Bénédicte tomate grillé ', '1500.00', NULL, 2),
(21, NULL, 'Toaste Frenchy ', 'Escalope - Oignons fris - Cheddar', '800.00', NULL, 2),
(22, NULL, 'Toaste Américain ', 'Steak - Bacon - Sauce giant', '800.00', NULL, 2),
(23, NULL, 'Toaste Mexicain', 'Bavette poivron oignons fris', '800.00', NULL, 2);
