...
//let data_update = input
    ...
    form.parse(req, function (err, fields, files) {
        ...
        category_module.category_update(id,data_update,function (err,result1) {
            if (err) console.log('error',err);
            doc_module.uploadFile('./../docDyn/public/img/category/',id,files,'main','main','jpg', function (err,count1){

                if (err) console.log(err)

                console.log('count1 : ',count1)
                doc_module.uploadMultiFile('./../docDyn/public/img/category/',id,files,'jpg', function (err,count2){
    ...
    form.parse(req, function (err, fields, files) {
        ...
        category_module.category_add(data_insert,function (err,result1) {
            ...
            doc_module.uploadFile('./../docDyn/public/img/category/',result1.insertId,files,'main','main','jpg', function (err,count1){
                ...
                console.log('count1 : ',count1)
                doc_module.uploadMultiFile('./../docDyn/public/img/category/',result1.insertId,files,'jpg', function (err,count2){
