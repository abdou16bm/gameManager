...
user_default_router.get('/profil',authentication_controller.isAuthenticated, user_default_controller.user_edit);
user_default_router.post('/profil',authentication_controller.isAuthenticated, user_default_controller.user_edit_save);
user_default_router.post('/signup', user_default_controller.user_signup_save);
